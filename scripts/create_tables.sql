...
CREATE TABLE `daily_technical_indicators` (
  ...
  `macd` decimal(10,6) DEFAULT 0 COMMENT 'MACD指标，趋势跟踪指标，正值看涨，负值看跌',
  `macd_ema1` decimal(10,6) DEFAULT 0 COMMENT 'MACD指标，ema1',
  `macd_ema2` decimal(10,6) DEFAULT 0 COMMENT 'MACD指标，ema2',
  `macd_dif` decimal(10,6) DEFAULT 0 COMMENT 'MACD DIF线，快线减慢线的差值',
  `macd_dea` decimal(10,6) DEFAULT 0 COMMENT 'MACD DEA线，DIF的EMA平滑线',
  `kdj_k` decimal(8,4) DEFAULT 0 COMMENT 'KDJ指标K值，范围0-100，随机指标',
  `kdj_d` decimal(8,4) DEFAULT 0 COMMENT 'KDJ指标D值，范围0-100，K值的平滑线',
  `kdj_j` decimal(8,4) DEFAULT 0 COMMENT 'KDJ指标J值，3K-2D，敏感度最高',
